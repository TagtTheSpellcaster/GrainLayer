...
GrainLayer was inspired by **[Deckle](https://projects.akshatkatiyar.com/projects/deckle/)**, a macOS application created by **Akshat Katiyar**. Its core idea—placing a subtle paper-like texture over the desktop—provided the starting point for GrainLayer's Windows implementation.

GrainLayer is an independent project. It is **not affiliated with, endorsed by, or an official Windows port of Deckle**.

Special thanks to **Akshat Katiyar** for the original idea and inspiration behind Deckle.

## About the development process

This project is also a case study in **AI-assisted programming and vibe coding**. The C++ implementation was produced and refined through an iterative dialogue with ChatGPT. The human role was to define requirements, test the resulting builds, report observed behaviour, evaluate proposed fixes, and decide which changes became part of the project.

The purpose of documenting the process is to make that development method explicit rather than presenting the source as if it had been written manually from scratch.
